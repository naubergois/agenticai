...
from workflow_agents.base_agents import ActionPlanningAgent  # ajuste o caminho se necessário

# TODO: 2 - Load environment variables and define the openai_api_key variable with your OpenAI API key
load_dotenv()
openai_api_key = os.getenv("OPENAI_API_KEY")

# Conhecimento sobre receitas de ovos
knowledge = """
# Fried Egg
...
# TODO: 4 - Print the agent's response
