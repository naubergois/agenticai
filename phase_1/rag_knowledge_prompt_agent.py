...
from workflow_agents.base_agents import RAGKnowledgePromptAgent  # Adjust path if needed
import os
...
rag_agent = RAGKnowledgePromptAgent(
    ...
    persona=persona,
    chunk_size=500,        # Optional: smaller chunks for more fine-grained retrieval
    chunk_overlap=50
)
...
# TODO: 3 - Compute chunks from the knowledge_text
chunks = rag_agent.chunk_text(knowledge_text)

# TODO: 4 - Compute the embeddings of the chunks
